...
const ProductSchema = ({
  ...
  const productUrl = `${baseUrl}/marketplace/products/${product.slug || product._id}`;
  const productImages = product.images?.map((img) => img.url).filter(Boolean);
  const productImage =
    productImages?.length > 0 ? productImages : [`${baseUrl}/og-image.jpg`];
...
export const ServiceSchema = ({
  ...
  const serviceUrl = `${baseUrl}/marketplace/services/${service.slug || service._id}`;
  ...
  const schema = {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        {
          "@type": "Offer",
          itemOffered: { "@type": "Service", name: "React Templates" },
        },
        {
          "@type": "Offer",
          itemOffered: { "@type": "Service", name: "API Development" },
        },
      ],
    },
    contactPoint: {
