...
const PremiumDropdown = ({ value, onChange, options, name }) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={`w-full flex items-center justify-between pl-12 pr-4 py-3 rounded-xl border bg-white/50 dark:bg-gray-800/50 text-left transition-all duration-200 outline-none
            ...
            >
                <span className="text-gray-900 dark:text-white truncate">{selectedOption.label}</span>
    ...
    <div className="space-y-8 animate-in fade-in duration-700 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <button
            ...
            disabled={isUpdating}
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl transition-all shadow-lg hover:shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
        >
            {isUpdating ? (
            ...
            <div className="space-y-6">
                <div className="group">
                    ...
                    <div className="relative">
                        <CreditCard className="absolute left-4 top-1/2 -translate-y-1/2 z-10 text-gray-400 group-focus-within:text-blue-500 transition-colors" size={20} />
                        <PremiumDropdown
                            name="currency"
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                        This currency will be displayed across your entire marketplace.
                    </p>
                </div>
                ...
                <div className="group">
                    ...
                    <div className="relative">
                     ...
                     <p className="mt-2 text-xs text-gray-500">
                        Percentage tax applied to all transactions by default.
                    </p>
                </div>
            </div>
        </div>
