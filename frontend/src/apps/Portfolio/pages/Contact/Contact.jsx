        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            ...
            <motion.h1 variants={itemVariants} className="text-5xl lg:text-7xl xl:text-8xl font-bold mb-8 leading-tight text-white">
              Get In <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-2xl">Touch</span>
            </motion.h1>
          ...
          {/* Availability Status */}
          <motion.div variants={itemVariants} className="inline-flex items-center gap-3 px-6 py-3 bg-slate-800/50 rounded-full border border-white/10 backdrop-blur-sm">
          ...
          <motion.div variants={itemVariants} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactMethods.map((method, index) => (
              <motion.a
                key={index}
                href={method.href || '#'}
                target={method.href && method.href.startsWith('http') ? '_blank' : '_self'}
                rel={method.href && method.href.startsWith('http') ? 'noopener noreferrer' : ''}
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              {/* Why Work With Me */}
              <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    <span className="text-cyan-400 text-xl">🎯</span>
                    <div>
                      <h4 className="text-white font-semibold mb-1">Goal-Oriented</h4>
                      <p className="text-slate-400 text-sm">Focused on delivering results that matter</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-cyan-400 text-xl">🤝</span>
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">I work closely with clients throughout the process</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-cyan-400 text-xl">🔧</span>
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">Clean, scalable, and maintainable code</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {Object.entries(socialLinks).map(([category, links]) =>
                    Object.entries(links).map(([platform, url]) => (
                      ...
                      >
                        <span>
                          {platform === 'github' && <Github className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'linkedin' && <Linkedin className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'twitter' && <Twitter className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'instagram' && <Instagram className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'facebook' && <Globe className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'telegram' && <Smartphone className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'discord' && <Smartphone className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'whatsapp' && <Phone className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'reddit' && <Globe className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                          {platform === 'portfolio' && <Globe className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors duration-300" />}
                        </span>
              ...
              <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-white/10">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-white font-semibold mb-2">What's your typical response time?</h4>
                    <p className="text-slate-400 text-sm">I usually respond within 24 hours, often much sooner.</p>
                  </div>
                  <div>
                    <h4 className="text-white font-semibold mb-2">Do you work with international clients?</h4>
                    <p className="text-slate-400 text-sm">Yes! I work with clients worldwide and am flexible with time zones.</p>
                  </div>
                  <div>
                    <h4 className="text-white font-semibold mb-2">What's your preferred project size?</h4>
                    <p className="text-slate-400 text-sm">I work on projects of all sizes, from small features to full applications.</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
        ...
        >
          <motion.div variants={itemVariants}>
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Let's Create Something <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">Extraordinary</span>
            </h2>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Every great project starts with a conversation. I'm excited to hear about your ideas and explore how we can bring them to life.
            </p>
