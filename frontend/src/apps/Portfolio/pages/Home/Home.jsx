          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <motion.div variants={itemVariants} className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-black tracking-tight text-white">
                Building Exceptional <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500 bg-clip-text text-transparent">Web Applications</span>
              </h2>
              <p className="text-lg text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium">
                I focus on creating fast, responsive, and beautiful websites using modern technologies that help businesses grow.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3 tracking-wide">Speed & Performance</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  Websites that load instantly, work smoothly, and keep your visitors engaged from the very first second.
                </p>
                {/* Friendly status tag */}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3 tracking-wide">Clean & Modern Design</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  Beautiful, simple, and friendly layouts built to be highly interactive and easy for everyone to enjoy.
                </p>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3 tracking-wide">Full-Stack Solutions</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  Secure databases and robust backend servers built to store your data safely and grow with your traffic.
                </p>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <motion.div variants={itemVariants} className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-black tracking-tight text-white">
                My Latest <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500 bg-clip-text text-transparent">Featured Projects</span>
              </h2>
              <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium">
                Here are a few select projects I've built using React, Node.js, MongoDB, and TypeScript.
              </p>
            </motion.div>
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-4 text-xs font-mono">
                      ...
                      <span className="text-slate-500 font-bold">{project.year}</span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-6">
                      {project.technologies.slice(0, 4).map((tech) => (
                        <span key={tech} className="px-2 py-1 bg-slate-900 border border-slate-800 text-slate-400 font-mono text-[10px] rounded font-semibold">
                          {tech}
                        </span>
                      ))}
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <motion.div variants={itemVariants} className="text-center mb-16 space-y-4">
              ...
              <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium">
                Here is a breakdown of the programming languages, frontend libraries, and backend frameworks I use.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <motion.div 
                ...
                whileHover={{ borderColor: "rgba(34, 211, 238, 0.3)", boxShadow: "0 0 25px rgba(6, 182, 212, 0.03)" }}
              >
                <div>
                  <div className="flex items-center gap-2 mb-6 text-cyan-400">
                    <Terminal className="w-5 h-5 text-cyan-400" />
                    <h3 className="text-2xl font-bold text-white tracking-wide">Frontend Core</h3>
                  </div>
                  <div className="space-y-4">
                    {technicalSkills.frontend.expert.map((skill) => (
                      <div key={skill} className="space-y-1.5">
                        <div className="flex justify-between items-center text-xs font-mono">
                          <span className="text-slate-200 font-bold">{skill}</span>
                          <span className="text-cyan-400 font-bold font-mono text-[10px]">EXPERT</span>
                        </div>
              ...
              <motion.div 
                variants={itemVariants} 
                className="bg-slate-950/80 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-xl flex flex-col justify-between text-left"
                whileHover={{ borderColor: "rgba(168, 85, 247, 0.3)", boxShadow: "0 0 25px rgba(139, 92, 246, 0.03)" }}
              >
                <div>
                  <div className="flex items-center gap-2 mb-6 text-purple-400">
                    <Server className="w-5 h-5 text-purple-400" />
                    <h3 className="text-2xl font-bold text-white tracking-wide">Backend Core</h3>
                  </div>
                  <div className="space-y-4">
                    {technicalSkills.backend.advanced.map((skill) => (
                      <div key={skill} className="space-y-1.5">
                        <div className="flex justify-between items-center text-xs font-mono">
                          <span className="text-slate-200 font-bold">{skill}</span>
                          <span className="text-purple-400 font-bold font-mono text-[10px]">ADVANCED</span>
                        </div>
                        <div className="w-full h-1.5 bg-slate-900 border border-slate-800 rounded-full overflow-hidden">
              ...
              <motion.div 
                variants={itemVariants} 
                className="bg-slate-950/80 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-xl flex flex-col justify-between text-left"
                whileHover={{ borderColor: "rgba(16, 185, 129, 0.3)", boxShadow: "0 0 25px rgba(16, 185, 129, 0.03)" }}
              >
                <div>
                  <div className="flex items-center gap-2 mb-6 text-emerald-400">
                    <Wrench className="w-5 h-5 text-emerald-400" />
                    <h3 className="text-2xl font-bold text-white tracking-wide">Control Tools</h3>
                  </div>
                  <div className="space-y-4">
                    {technicalSkills.tools.expert.map((skill) => (
                      <div key={skill} className="space-y-1.5">
                        <div className="flex justify-between items-center text-xs font-mono">
                          <span className="text-slate-200 font-bold">{skill}</span>
                          <span className="text-emerald-400 font-bold font-mono text-[10px]">EXPERT</span>
                        </div>
                        <div className="w-full h-1.5 bg-slate-900 border border-slate-800 rounded-full overflow-hidden">
