const aiToolsData = [
  ...
  // NEW 2026 TRENDING TOOLS
  { id: 87, name: "DeepSeek V3", category: "Chatbots & Assistants", description: "Open-source Chinese AI model rivaling GPT-4 with 685B parameters, superior coding abilities, and fully open weights.", url: "https://deepseek.ai", pricing: "Free", featured: true, tags: ["open-source", "coding", "chinese", "large-model"], logo: "🔮", rating: 4.8, users: "20M+", bestFor: "Best Open Source" },
  { id: 88, name: "Gemini 2.0 Flash", category: "Chatbots & Assistants", description: "Google's fastest multimodal AI with native image/audio generation, real-time streaming, and 1M token context.", url: "https://ai.google.dev/gemini-api", pricing: "Freemium", featured: true, tags: ["google", "multimodal", "fast", "streaming"], logo: "⚡", rating: 4.9, users: "100M+", bestFor: "Fastest AI" },
  { id: 89, name: "Claude 3.5 Sonnet", category: "Chatbots & Assistants", description: "Anthropic's most intelligent model with Artifacts for creating documents, code, and interactive content in real-time.", url: "https://claude.ai", pricing: "Freemium", featured: true, tags: ["anthropic", "artifacts", "coding", "analysis"], logo: "🧠", rating: 4.9, users: "60M+", bestFor: "Best for Coding" },
  { id: 90, name: "o1 Pro", category: "Chatbots & Assistants", description: "OpenAI's most powerful reasoning model with PhD-level accuracy in math, science, and complex problem-solving.", url: "https://chat.openai.com", pricing: "Premium", featured: true, tags: ["reasoning", "math", "science", "research"], logo: "🎓", rating: 4.9, users: "50M+", bestFor: "Best for Research" },
  { id: 91, name: "Grok 2", category: "Chatbots & Assistants", description: "xAI's latest model with image understanding, real-time X integration, and unfiltered conversational style.", url: "https://grok.x.ai", pricing: "Premium", featured: false, tags: ["xai", "images", "real-time", "unfiltered"], logo: "🔥", rating: 4.7, users: "25M+" },
  { id: 92, name: "Krea AI", category: "Image Generation", description: "Real-time AI image generation and editing with live canvas, screen sharing, and instant style transfer.", url: "https://krea.ai", pricing: "Freemium", featured: true, tags: ["real-time", "canvas", "editing", "fast"], logo: "🎨", rating: 4.8, users: "3M+", bestFor: "Real-Time Generation" },
  { id: 93, name: "Recraft V3", category: "Image Generation", description: "Best-in-class text rendering in images with vector output, brand consistency, and design-focused generation.", url: "https://recraft.ai", pricing: "Freemium", featured: false, tags: ["text-in-image", "vector", "design", "brand"], logo: "✒️", rating: 4.8, users: "2M+" },
  { id: 94, name: "Kling AI", category: "Video Generation", description: "Chinese video AI generating 2-minute videos with motion brush, lip sync, and professional-grade quality.", url: "https://klingai.com", pricing: "Freemium", featured: true, tags: ["long-video", "motion", "lip-sync", "chinese"], logo: "🎬", rating: 4.8, users: "5M+", bestFor: "Longest Videos" },
  { id: 95, name: "Minimax Hailuo", category: "Video Generation", description: "State-of-the-art video generation with natural motion, 6-second high-quality clips, and realistic physics.", url: "https://hailuoai.video", pricing: "Free", featured: false, tags: ["free", "motion", "physics", "quality"], logo: "🌊", rating: 4.7, users: "8M+" },
  { id: 96, name: "Devin", category: "Coding & Development", description: "World's first AI software engineer that can plan, code, debug, and deploy entire projects autonomously.", url: "https://cognition.ai", pricing: "Premium", featured: true, tags: ["autonomous", "full-stack", "agentic", "enterprise"], logo: "🤖", rating: 4.8, users: "100K+", bestFor: "AI Software Engineer" },
  { id: 97, name: "Windsurf", category: "Coding & Development", description: "Codeium's agentic IDE with Cascade flows for multi-file editing, deep codebase understanding, and natural language commands.", url: "https://codeium.com/windsurf", pricing: "Free", featured: true, tags: ["ide", "agentic", "flows", "free"], logo: "🏄", rating: 4.9, users: "500K+", bestFor: "Best Free IDE" },
  { id: 98, name: "Trae AI", category: "Coding & Development", description: "ByteDance's AI coding assistant with builder mode for generating full applications from descriptions.", url: "https://trae.ai", pricing: "Free", featured: false, tags: ["bytedance", "builder", "full-stack", "free"], logo: "🏗️", rating: 4.6, users: "200K+" },
  { id: 99, name: "Napkin AI", category: "Design & UI/UX", description: "Turn text into professional diagrams and visuals instantly. Perfect for presentations, documentation, and social media.", url: "https://napkin.ai", pricing: "Freemium", featured: true, tags: ["diagrams", "visuals", "presentations", "instant"], logo: "📊", rating: 4.8, users: "1M+", bestFor: "Best for Diagrams" },
  { id: 100, name: "Gamma", category: "Design & UI/UX", description: "AI-powered presentation and document creator with beautiful templates, one-click design, and export to PowerPoint.", url: "https://gamma.app", pricing: "Freemium", featured: true, tags: ["presentations", "documents", "templates", "ai-design"], logo: "📑", rating: 4.8, users: "5M+", bestFor: "Best for Presentations" },
  { id: 101, name: "Fal.ai", category: "Image Generation", description: "Lightning-fast inference platform for AI models. Generate images in milliseconds with optimized pipelines.", url: "https://fal.ai", pricing: "Freemium", featured: false, tags: ["fast", "inference", "api", "developers"], logo: "⚡", rating: 4.7, users: "500K+" },
  { id: 102, name: "Anthropic MCP", category: "Productivity & Automation", description: "Model Context Protocol connecting Claude to databases, APIs, and tools for powerful agentic workflows.", url: "https://anthropic.com/mcp", pricing: "Free", featured: false, tags: ["protocol", "integration", "agentic", "open-source"], logo: "🔗", rating: 4.7, users: "100K+" },
];
