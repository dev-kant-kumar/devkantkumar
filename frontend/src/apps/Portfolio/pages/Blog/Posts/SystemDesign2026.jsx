...
const SystemDesignQuestions = React.lazy(()=>import("./SystemDesignQuestions"));
const SystemDesignRoadmap = React.lazy(()=>import("./SystemDesignRoadMap2026"));
...
function SystemDesignFeaturedImage({ className = "" }) {
  return (
    <div className={`relative overflow-hidden group ${className}`}>
        <img
            src="/images/blog/system-design-2026.jpg"
...
export const info = {
  ...
  keywords:
    "system design roadmap, system design roadmap 2026, system design interview preparation, system design interview roadmap, learn system design from scratch, system design for beginners, how to prepare for system design interviews, scalable system design, distributed systems roadmap, backend system design",
};
