          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Discover high-quality templates, themes, plugins, and digital
                assets. Launch your project faster with our premium resources.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Select the perfect asset and complete checkout.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Get instant download link and license key.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Integrate and launch faster than ever.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search..."
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-blue-400 transition-all"
                  />
                </div>
              </div>
      ...
      <div className="bg-blue-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join creators and get notified when we launch new templates and
            resources.
          </p>
