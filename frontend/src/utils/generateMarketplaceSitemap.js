...
async function fetchAllProducts() {
  try {
    const res = await fetch(
      `${API_BASE}/api/marketplace/products?limit=1000&status=published`,
    );
...
async function fetchAllServices() {
  try {
    const res = await fetch(
      `${API_BASE}/api/marketplace/services?limit=1000&status=published`,
    );
    const data = await res.json();
...
async function generateSitemap() {
  ...
  const staticPages = [
    ...
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/products`,
      changefreq: "daily",
      priority: "0.9",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/services`,
      changefreq: "daily",
      priority: "0.9",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/custom-solutions`,
      changefreq: "weekly",
      priority: "0.8",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/support`,
      changefreq: "monthly",
      priority: "0.7",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/contact`,
      changefreq: "monthly",
      priority: "0.7",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/faq`,
      changefreq: "monthly",
      priority: "0.6",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/terms`,
      changefreq: "monthly",
      priority: "0.5",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/privacy`,
      changefreq: "monthly",
      priority: "0.5",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/refunds`,
      changefreq: "monthly",
      priority: "0.5",
    }),
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/license`,
      changefreq: "monthly",
      priority: "0.5",
    }),
  ];
  ...
  const productEntries = products.map((product) =>
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/products/${product.slug || product._id}`,
  ...
  const serviceEntries = services.map((service) =>
    buildUrlEntry({
      loc: `${BASE_URL}/marketplace/services/${service.slug || service._id}`,
...
${serviceEntries.join("\n")}
  ...
  console.log(
    `Total URLs: ${staticPages.length + productEntries.length + serviceEntries.length}`,
  );
}
