...
const supportTicketSchema = new mongoose.Schema(
  {
    ...
    // Source of ticket submission
    source: {
      type: String,
      enum: ["support-page", "contact-page", "dashboard", "admin"],
...
// Update lastActivity on new responses
...
supportTicketSchema.index({ user: 1, status: 1, lastActivity: -1 });
