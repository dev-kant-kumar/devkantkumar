...
const serviceSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: ['web-development', 'mobile-development', 'ui-ux-design', 'backend-development', 'consulting', 'maintenance', 'custom-solutions']
  },
  subcategory: {
    type: String,
    trim: true
...
serviceSchema.methods.checkAvailability = function() {
  ...
  if (this.availability.nextAvailableDate && this.availability.nextAvailableDate > new Date()) return false;
  if (this.availability.currentMonthOrders >= this.availability.maxOrdersPerMonth) return false;
  return true;
};
