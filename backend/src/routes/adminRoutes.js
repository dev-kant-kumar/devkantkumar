...
router.get(
  ...
  adminMarketplaceController.getProductAnalytics,
);
...
// Catch-all for non-POST methods to the sync endpoint. If an authenticated
// admin issues a GET (or other method) by mistake, return a clear 405 rather
// than the generic 404 handler.
router.all("/merchant-center/sync", (req, res, next) => {
  ...
  return res
    ...
    .json({
      success: false,
      message:
        "Method Not Allowed. Use POST /api/v1/admin/merchant-center/sync to trigger a sync.",
    });
});

router.post(
  "/merchant-center/sync",
  adminMarketplaceController.syncMerchantCenter,
);
...
router.get(
  ...
  adminMarketplaceController.getServiceAnalytics,
);
...
router.put(
  ...
  adminMarketplaceController.updateAdminOrderStatus,
);
router.post(
  "/marketplace/orders/:id/requirements/approve",
  adminMarketplaceController.approveRequirements,
);
router.post(
  "/marketplace/orders/:id/requirements/request-changes",
  adminMarketplaceController.requestRequirementsChanges,
);
router.post(
  "/marketplace/orders/:id/milestones",
  adminMarketplaceController.addMilestone,
);
router.put(
  "/marketplace/orders/:id/milestones/:milestoneId",
  adminMarketplaceController.updateMilestone,
);
router.post(
  "/marketplace/orders/:id/messages",
  adminMarketplaceController.addAdminMessage,
);
router.post(
  "/marketplace/orders/:id/deliver",
  adminMarketplaceController.markDelivered,
);
router.post(
  "/marketplace/orders/:id/phases/:phaseKey/complete",
  adminMarketplaceController.completePhase,
);
router.post(
  "/marketplace/orders/:id/approvals",
  adminMarketplaceController.markApproval,
);
router.get("/marketplace/stats", adminMarketplaceController.getStats);
router.get(
  "/marketplace/analytics",
  adminMarketplaceController.getMarketplaceAnalytics,
);
...
router.post(
  ...
  adminController.initiatePasswordChange,
);
